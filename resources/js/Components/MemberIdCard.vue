...
<template>
    <!-- Mirrors legacy assets/css/testadmin/pages/id-card.css exactly: title + ID
    ...
    <FlipCard class="mx-auto w-full max-w-[280px]">
        <template #front>
            ...
            >
                <p class="absolute left-1/2 top-[21%] -translate-x-1/2 whitespace-nowrap text-[1.4rem] font-bold text-slate-800">
                    PROCTAD
                </p>
