        ...
        <div v-else class="mt-6 grid gap-6 lg:grid-cols-3">
            ...
            <div class="rounded-xl border border-slate-200 bg-white p-6 lg:col-span-2">
                ...
                <ul class="mt-5 divide-y divide-slate-100">
                    <li v-for="req in requirements" :key="req.label" class="flex items-start gap-3 py-3">
                        <span
                ...
                <p class="mt-4 text-xs text-slate-400">
                    Requirements are validated by your Testing Center. Contact them to update any item.
                </p>
            </div>
        </div>
    </DashboardLayout>
