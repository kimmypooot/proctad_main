...
return [
    ...
    */
    ...
    'options' => [
         ...
         */
        /*
         * SECURITY: narrowed from base_path() to the directories the PDF
         * templates actually read from — letterheads, signatures and member
         * photos on the private disk, plus the bundled brand imagery and fonts.
         *
         * base_path() put .env, the whole vendor tree and (before they were
         * removed) the legacy database dumps inside dompdf's reach, which
         * matters because several published dompdf advisories are local file
         * read or file-existence oracles reached through SVG and @font-face.
         * chroot is the boundary those stop at.
         */
